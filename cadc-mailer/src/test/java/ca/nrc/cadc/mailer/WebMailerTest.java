...
public class WebMailerTest
{
    ...
    public void createLink() throws Exception
    {
        ...
        WebMailer testSubject = new WebMailer(SiteRole.CANFAR, "www.mysite.com",
                                     stubBundle);

        final URL linkURL = testSubject.createLink("MYTOKEN88");
        assertEquals("Wrong link.",
                     "https://www.mysite.com/canfar/newPassword.html?token=MYTOKEN88",
                     linkURL.toExternalForm());
    }
    ...
    public void sendMail() throws Exception
    {
        ...
        bundleMap.put("ORG_NAME_CADC",
                      "Centre canadien de données astronomiques");
        bundleMap.put("BODY_CONTENT",
                      "MESSAGE %s WITH %s (%s) TOKEN REPLACEMENTS %s.");
       ...
       WebMailer testSubject2 = (new WebMailer(SiteRole.CADC, "www.astrosite.com",
                                     stubBundle)
        {
            @Override
            Mailer createMailer()
        ...
        mockMailer.setBody("MESSAGE CCDA WITH https://www.astrosite.com/fr/auth/nouveauMotDePasse.html?token=MYTOKEN99 (https://www.astrosite.com/fr/auth/nouveauMotDePasse.html?token=MYTOKEN99) TOKEN REPLACEMENTS Centre canadien de données astronomiques.");
        expectLastCall().once();

        mockMailer.setContentType(Mailer.HTML_CONTENT_TYPE);
        expectLastCall().once();
        ...
        final String redirect =
                testSubject2.sendMail("me@where.com", "MYTOKEN99");
